# Start Naia server and client
Write-Host "Starting Naia server and client..."
...
Kill-ProcessOnPort 14193  # Naia server
Kill-ProcessOnPort 5174  # Vite client

# Start Naia server (no admin needed)
$serverArgs = @(
    '-NoExit',
    '-Command',
    'cd C:\TEMP\_WEB\FPSWebTest\server_naia; .\_run.bat'
)
